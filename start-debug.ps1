# start-debug.ps1
# Clean visible rollback launcher for eBay Automation.
# Bot Chrome VISIBLE, terminal VISIBLE. No dialog.

Write-Host "=== eBay Automation (Visible Rollback) ===" -ForegroundColor Cyan
Write-Host "Bot Chrome: VISIBLE"
Write-Host "Terminal: VISIBLE"
Write-Host "Log into eBay only in the bot Chrome."

$chromePath = "C:\Program Files\Google\Chrome\Application\chrome.exe"
$debugPort = 9223
$userDataDir = "C:\ebay-automation-profile"
...
Get-CimInstance Win32_Process -Filter "Name = 'chrome.exe'" -ErrorAction SilentlyContinue | ForEach-Object {
    if ($_.CommandLine -and ($_.CommandLine -like "*ebay-automation-profile*" -or $_.CommandLine -like "*remote-debugging-port=9223*")) {
...
Get-Process "eBay Automation" -ErrorAction SilentlyContinue | ForEach-Object {
    Stop-Process -Id $_.Id -Force -ErrorAction SilentlyContinue
}
